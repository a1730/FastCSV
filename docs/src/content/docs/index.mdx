...
:::caution[Only 4.x is maintained]
The 3.x and 2.x lines have reached end of life. They receive no further releases – including **no security
fixes**. Please upgrade to 4.x; see the [security policy](https://github.com/osiegmar/FastCSV/blob/main/SECURITY.md)
for details.
:::
